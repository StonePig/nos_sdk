...
[GROUP]
GROUP={UART,IEM_SIMU,APP_SIMU}

[IEM_SIMU]
DISP_NAME=IEM SIMU
WIDTH=400
CONTROL_NAME={开关,亮度,高度,缩放,显示模式}
CONTROL_TYPE={CHECK,STATIC,STATIC,STATIC,STATIC}
CONTROL_NAME_WIDTH={210}
CONTROL_HEIGHT={33}
...
WIDTH=400
CONTROL_NAME={开关,亮度,高度,缩放,显示模式}
CONTROL_TYPE={CHECK,SLIDER,SLIDER,SLIDER,CHECK}
CONTROL_NAME_WIDTH={210}
CONTROL_HEIGHT={33}
SLIDER_MIN={,0,0,0}
SLIDER_MAX={,14,6,2}
...
7. **字体设置**：字体大小范围通常为8-240
8. **编码格式**: ui.ini文件的编码格式必须为utf-8
