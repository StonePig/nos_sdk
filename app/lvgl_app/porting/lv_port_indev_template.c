...
void lv_port_indev_init(void)
{
    ...
    static lv_indev_drv_t indev_drv, indev_touchpad_drv, indev_encoder_drv;
...
static bool touchpad_is_pressed(void)
{
    ...
    return(drv_touchpad_is_pressed());
}
...
{
#if ENCODER_NUM
    data->enc_diff = (int16_t)nos_encode_get_speed(0);
    if(data->enc_diff != 0)
    {       
        data->state = LV_INDEV_STATE_PR;
        if(data->enc_diff > 0)
